 ...
 <br>
  ...
  <table class="w3-table-all" style="width:70%;">
   ...
   <!--  <tr>
    ...
    <tr>
              <td><a data-toggle="modal" data-target="#myModal2" style="cursor: pointer">Carta del crédito</a>
        Modal
                          <div class="modal fade" id="myModal2" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Carta del crédito</h4>
                                </div>
                                <div class="modal-body">
   ...
   <!-- <tr>
    ...
    <tr>
     ...
     <tr>
          <td colspan="4">
             <br><a> - Para inmuebles fuera de Bogotá los comprobantes fiscales serán el paz y salvo por predial y valorización, para la anualidad en la que se escritura. En caso que el municipio no tenga valorización, así deberá ser certificado por el ente encargado del recaudo del impuesto<br><br></a><br></td>
