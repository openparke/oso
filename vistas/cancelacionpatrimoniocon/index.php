...
<div class="w3-container" align="center" style="padding-top: 6%;padding-left: 5%;">
  ...
  <h2 style="padding-bottom: 3%;"> Cancelación de Patrimonio familiar con menores de edad </h2>
  ...
  <table class="w3-table-all" style="width:70%;">
   ...
   <tr>
    ...
    <tr>
     ...
     <tr>
         <td><a data-toggle="modal" data-target="#myModal2" style="cursor: pointer">  Impuesto predial vigente del año en curso</a>
        <!-- Modal -->
                          <div class="modal fade" id="myModal2" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Impuesto predial vigente del año en curso</h4>
                                </div>
                                <div class="modal-body">
   ...
   <!--  <tr>
    ...
    <tr>
      ...
      <td></td>
          ...
          <td><a data-toggle="modal" data-target="#myModal6" style="cursor: pointer">Promesa de compraventa del otro inmueble</a>
       
                          <div class="modal fade" id="myModal6" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Promesa de compraventa del otro inmueble</h4>
                                </div>
                                <div class="modal-body">
    ...
    <tr>
          <td> <a data-toggle="modal" data-target="#myModal9" style="cursor: pointer">Registro civil de matrimonio</a>
        
                          <div class="modal fade" id="myModal9" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Registro civil de matrimonio</h4>
                                </div>
                                <div class="modal-body">
                                  <iframe src="vistas/mantenimiento/mantenimiento.png" width="770" height="530" style="border: none;"></iframe>
                                </div>
      ...
      <tr>
          <td> <a data-toggle="modal" data-target="#myModal3" style="cursor: pointer">Registros civiles de los menores</a>
        
                          <div class="modal fade" id="myModal3" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Registros civiles de los menores</h4>
                                </div>
                                <div class="modal-body">
                                  <iframe src="vistas/mantenimiento/mantenimiento.png" width="770" height="530" style="border: none;"></iframe>
                                </div>
