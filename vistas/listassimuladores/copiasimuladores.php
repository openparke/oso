 <?php if($_SESSION['Rol']=="Informador"):?><!-- Informador-->
  <aside class="app-sidebar">
      ...
      <ul class="app-menu">
              ...
              <li style="padding-left: 20%;"><img src="Davivienda/img/notaria/logob.png" style="width: 100px;" ></li><br>
            ...
            <li><a class="app-menu__item"  href="?c=solicitud&a=registrarsolicitud"><i class="app-menu__icon colorp fa fa fa-clipboard" ></i><span class="app-menu__label" > Solicitud</span></a></li>
                        ...
                        <ul  class="nav nav-pills">
                          ...
                          <div class="tab-pane" id="2a">
                           ...
                           <div style="padding-left:0%;">
                             <input type="button" class="btn btn-primary" value="Ver Respuesta" style="
                            border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;  border-radius: 5px;" onClick="window.location='?c=solicitud'">
                </div>
