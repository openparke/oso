...
// valores para multiplicar
        ...
        //Retencionjuridico=ValEscritura*(0.025);
        Mayor=ValEscritura*(0.02);     // mayor a 910 millones
...
// formulario gastos vendedor
        ...
        $("#Retencion").val(Retencion);
         //$("#Retencionjuridico").val(Retencionjuridico);
        ...
        $("#totalv").val(gastosnotarialesvendedor+hojasnotarialesvendedor+fotocopiasotrosvendedor+supernotariadovendedor+Retencion+ivavendedor); //total vendedor
         $("#totaljuridico").val(gastosnotarialesvendedor+hojasnotarialesvendedor+fotocopiasotrosvendedor+supernotariadovendedor+ivavendedor);//total con juridica
// formulario gastos comprador
        ...
        if (ValEscritura >= 918346000) {

             $("#totalc").val(gastosnotarialescomprador+hojasnotarialescomprador+fotocopiasotroscomprador+supernotariadocomprador+impotros+registro+benefi+ivacomprador+Mayor);//total comprador
