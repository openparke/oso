...
WHERE "idUsuario"=?; ');
   ...
   public function Insertar(resolicitud $p){
...
public function Actualizar(resolicitud $p){
    ...
    try{
        ...
        "tipopersona"=?,"tipoacto"=?,"ValEscritura"=?,"ValHipoteca"=?,"ValVenta"=?,
        "docprimernotaria"=?,"docsegundonotaria"=?,"docterceronotaria"=?,"doccuartonotaria"=?,"docquintonotaria"=?,
        "checkprimero"=?,"checksegundo"=?,"checktercero"=?,"checkcuarto"=?,"checkquinto"=?,"viabilidad"=?,"observacionesnotaria"=?,"fechanotaria"=?
        WHERE "idsolicitud"=?;');
