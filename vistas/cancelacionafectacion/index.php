...
<div class="w3-container" align="center" style="padding-top: 6%;padding-left: 5%;">
  ...
  <h2 style="padding-bottom: 3%;"> Cancelación de afectación a vivienda familiar </h2>
  ...
  <table class="w3-table-all" style="width:70%;">
   ...
   <!-- <tr>
          <td><a data-toggle="modal" data-target="#myModal6" style="cursor: pointer">Registro civil de matrimonio ( Si hay un solo comprador y es casado ) comparecen los dos (2)</a>
        
                          <div class="modal fade" id="myModal6" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title">Registro civil de matrimonio ( Si hay un solo comprador y es casado ) comparecen los dos (2)</h4>
                                </div>
                                <div class="modal-body">
     ...
     <tr>
          <td colspan="4">
             <br><br><a> - Si  son compañeros comparecen los (2)<br><br></a><br></td>
