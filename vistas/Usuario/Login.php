...
<html >
    ...
    <link rel="stylesheet" href="../../modal/assets/css/form-elements.css">
     ...
     <script src='https://www.google.com/recaptcha/api.js?render=6Lcj7n0UAAAAAOrPeoSxMebxdV4GbElnI6SeOgRm'></script>
     
     <script>
grecaptcha.ready(function() {
grecaptcha.execute('6Lcj7n0UAAAAAOrPeoSxMebxdV4GbElnI6SeOgRm', {action: 'action_name'})
.then(function(token) {
