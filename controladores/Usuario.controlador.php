...
class UsuarioControlador {
    ...
    public function FormLogin() {
        //require_once "vistas/Usuario/Login.php";//esta es la vista que se carga sin iniciar sesi¨®n, aqu¨ª puedes ponder lo que necesitas y dentro de esto poner un modal del login. 
        require_once "vistas/Inicio/template.php";
    }

    public function Iniciar() {//Desde este metodo se inicia sesi¨®n
